...
class BusinessesAdapter(private val items: List<Businesses>):
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int):
        ...
        return BusinessViewHolder(
            ...
            LayoutInflater.from(parent.context).inflate(R.layout.business_adapter, parent,
                false)
        )
    }
    ...
    class BusinessViewHolder constructor(
        ...
        fun bind(businesses: Businesses) {
            ...
            saveToList.setOnClickListener{
                DataMediator.addBusiness(Business("${businesses.id}", "${businesses.name}",
                    "${businesses.phone}", "${businesses.location.city}", "${businesses.location.address1}",
